...
def path3():
    print(
        "You climn down the vines into the bottomless hole(Pit! it's a god-damned pit, capice?)."
    )
    time.sleep(a)
    print(
    ...
    time.sleep(a)
    print(
        "You continue climbing down the vines until you hear soemthing whirring up at you."
    )
    time.sleep(a)
    print("Someone class out to you.")
    time.sleep(a)
    print()
    s1 = '"Hey, hey there!...'
    for character in s1:
